...
const fr: typeof en = {
  ...
  sample: {
    ...
    issuedShort: "Émis",
    confidentialNote: "Ce rapport contient des renseignements d'affaires partagés à titre confidentiel. Ne pas le transférer sans le consentement du destinataire.",
    overall: "Global",
